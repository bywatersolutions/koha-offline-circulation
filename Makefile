...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Fri Jan 8 13:15:58 2010
...
qrc_koc.cpp: koc.qrc \
		images/button-icons/edit-delete.png \
		images/button-icons/system-search.png \
		images/icons/koha-logo.png \
		images/icons/document-open.png \
		images/icons/program-quit.png \
		images/icons/document-new.png \
		images/icons/document-close.png \
